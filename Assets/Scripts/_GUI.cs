...
/// <summary>
/// The following code are largely based on the post https://stackoverflow.com/questions/58441744/how-to-enable-disable-a-list-in-unity-inspector-using-a-bool.
/// They have no practical usage in game logic, it only helps to manage the inspector UI for faster tunning.
/// `[Space(20)]` to manage space in inscpector.
/// `[Tooltip("TXT")]` to add on hover text.
/// `[ShowIf(ActionOnConditionFail.DisableOnly, ConditionOperator.And, nameof(VAR))]` to connect SerializeField.
/// </summary>
